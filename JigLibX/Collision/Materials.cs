...
namespace JigLibX.Collision
{
    ...
    public class MaterialTable
    {
        ...
        private Dictionary<KeyValuePair<int, int>, MaterialPairProperties> materialPairs =
            new Dictionary<KeyValuePair<int, int>, MaterialPairProperties>();
        ...
        public void SetMaterialProperties(int id, MaterialProperties properties)
        {
            ...
            foreach (KeyValuePair<int, MaterialProperties> it in materials)
            {
                ...
                materialPairs[new KeyValuePair<int, int>(otherID, id)] =
                materialPairs[new KeyValuePair<int, int>(id, otherID)] =
        ...
        {
            return materialPairs[new KeyValuePair<int, int>(id1, id2)];
        }
        ...
        {
            materialPairs[new KeyValuePair<int, int>(id1, id2)] =
            materialPairs[new KeyValuePair<int, int>(id2, id1)] =
            pairProperties;
        }
