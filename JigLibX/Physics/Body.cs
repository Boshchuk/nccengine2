...
namespace JigLibX.Physics
{
    ...
    public partial class Body
    {
        ...
        public void GetVelocity(ref Vector3 relPos, out Vector3 result)
        {
            ...
            result.X = fX;result.Y = fY;result.Z = fZ;
        }
        ...
        public Vector3 GetVelocityAux(Vector3 relPos)
        {
            ...
            float fX = transformRateAux.Velocity.X + transformRateAux.AngularVelocity.Y * relPos.Z - transformRateAux.AngularVelocity.Z * relPos.Y;
            float fY = transformRateAux.Velocity.Y + transformRateAux.AngularVelocity.Z * relPos.X - transformRateAux.AngularVelocity.X * relPos.Z;
            float fZ = transformRateAux.Velocity.Z + transformRateAux.AngularVelocity.X * relPos.Y - transformRateAux.AngularVelocity.Y * relPos.X;
            result.X = fX;result.Y = fY;result.Z = fZ;
            return result;
        }
