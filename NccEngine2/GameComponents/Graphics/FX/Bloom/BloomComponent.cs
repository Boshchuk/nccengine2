...
namespace NccEngine2.GameComponents.Graphics.FX.Bloom
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = BaseEngine.ContentManager.Load<Effect>("Content/Shaders/Bloom/BloomExtract");
            bloomCombineEffect = BaseEngine.ContentManager.Load<Effect>("Content/Shaders/Bloom/BloomCombine");
            gaussianBlurEffect = BaseEngine.ContentManager.Load<Effect>("Content/Shaders/Bloom/GaussianBlur");

            // Look up the resolution and format of our main backbuffer.
            var presentationParameters = BaseEngine.Device.PresentationParameters;
            ...
            sceneRenderTarget = new RenderTarget2D(BaseEngine.Device, width, height, false,
                surfaceFormat, presentationParameters.DepthStencilFormat, presentationParameters.MultiSampleCount
            ...
            renderTarget1 = new RenderTarget2D(BaseEngine.Device, width, height, false, surfaceFormat, DepthFormat.None);
            renderTarget2 = new RenderTarget2D(BaseEngine.Device, width, height, false, surfaceFormat, DepthFormat.None);
        }
        ...
        {
            BaseEngine.Device.SetRenderTarget(renderTarget);
