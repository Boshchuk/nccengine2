...
namespace NccEngine2.GameComponents.Graphics.FX.LensFlare
{
    /// <summary>
    ...
    public class LensFlareComponent : DrawableGameComponent
    {
        ...
        public Vector3 LightDirection = Vector3.Normalize(new Vector3(-1, -0.5f, -3.5f));


        // Computed by UpdateOcclusion, which projects LightDirection into screenspace.
        Vector2 lightPosition;
        private bool lightBehindCamera;

        public bool MakeDraw { get; set; }
        ...
        Flare[] flares =
        {
            new Flare(-0.5f, 0.7f, new Color( 50,  25,  50), ConstantNames.LensFlare1),
            new Flare( 0.3f, 0.4f, new Color(100, 255, 200), ConstantNames.LensFlare1),
            new Flare( 1.2f, 1.0f, new Color(100,  50,  50), ConstantNames.LensFlare1),
            new Flare( 1.5f, 1.5f, new Color( 50, 100,  50), ConstantNames.LensFlare1),

            new Flare(-0.3f, 0.7f, new Color(200,  50,  50), ConstantNames.LensFlare2),
            new Flare( 0.6f, 0.9f, new Color( 50, 100,  50), ConstantNames.LensFlare2),
            new Flare( 0.7f, 0.4f, new Color( 50, 200, 200), ConstantNames.LensFlare2),

            new Flare(-0.7f, 0.7f, new Color( 50, 100,  25), ConstantNames.LensFlare3),
            new Flare( 0.0f, 0.6f, new Color( 25,  25,  25), ConstantNames.LensFlare3),
            new Flare( 2.0f, 1.4f, new Color( 25,  50, 100), ConstantNames.LensFlare3),
        };
        ...
        protected override void LoadContent()
        {
            ...
            glowSprite = Game.Content.Load<Texture2D>(ConstantNames.LensFlareGlow);
...
//**********************************
//NOTE is not reusable
            const int param =80;
            if ((lightPosition.X < param) ||(lightPosition.X>viewport.Width-param ))
            {
                lightBehindCamera = true;
                return;
            }
