...
namespace JigLibX.Collision
{
    ...
    public class CollisionSkin
    {
        ...
        private AABox worldBoundingBox = new AABox();
        ...
        public void UpdateWorldBoundingBox()
        {
            ...
            for (int iold = primitivesOldWorld.Count; iold-- != 0; )
                worldBoundingBox.AddPrimitive(primitivesOldWorld[iold]);

            if (collSystem != null && collSystem.UseSweepTests)
            {
                for (int inew = primitivesNewWorld.Count; inew-- != 0; )
                    worldBoundingBox.AddPrimitive(primitivesNewWorld[inew]);
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AABox WorldBoundingBox
        {
            get { return worldBoundingBox; }
        }
