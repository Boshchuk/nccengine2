...
namespace JigLibX.Collision
{
    ...
    public class CollDetectSpherePlane : DetectFunctor
    {
        ...
        public override void CollDetect(CollDetectInfo info, float collTolerance, CollisionFunctor collisionFunctor)
        {
            ...
            CollPointInfo collInfo = new CollPointInfo(worldPos - body0Pos,worldPos - body1Pos,oldDepth);
            List<CollPointInfo> collPts = new List<CollPointInfo>(1);
            collPts.Add(collInfo);
