...
namespace NccEngine2.GameDebugTools
{
    /// <summary>
    ...
    public class RemoteDebugCommand : GameComponent,IDebugCommandExecutioner, IDebugEchoListner
    {
            ...
            switch (phase)
            {
                ...
                case ConnectionPahse.Joining:
                    ...
                    if (asyncResult.IsCompleted)
                    {
                        ...
                        NetworkSession.SessionEnded += NetworkSessionSessionEnded;
        ...
        /// </summary>
        void NetworkSessionSessionEnded(object sender, NetworkSessionEndedEventArgs e)
        {
            DisconnectedFromRemote();
